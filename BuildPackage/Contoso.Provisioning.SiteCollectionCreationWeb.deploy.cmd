...
set _DeploySetParametersFile=%RootPath%Contoso.Provisioning.SiteCollectionCreationWeb.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Contoso.Provisioning.SiteCollectionCreationWeb.zip" (
echo "%RootPath%Contoso.Provisioning.SiteCollectionCreationWeb.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Contoso.Provisioning.SiteCollectionCreationWeb.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Contoso.Provisioning.SiteCollectionCreationWeb.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Contoso.Provisioning.SiteCollectionCreationWeb.deploy-readme.txt" (
...
start notepad "%RootPath%Contoso.Provisioning.SiteCollectionCreationWeb.deploy-readme.txt"
)
echo =========================================================
goto :eof
